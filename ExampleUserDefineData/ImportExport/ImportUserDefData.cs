...
namespace ExampleUserDefineData.ImportExport
{
    // 匯入自訂資料欄位
    class ImportUserDefData:SmartSchool.API.PlugIn.Import.Importer 
    {
        ...
        public override void InitializeImport(SmartSchool.API.PlugIn.Import.ImportWizard wizard)
        {
            ...
            // 取得自訂資料欄位資料
            Dictionary<string,List<DAL.UserDefData>> UserDefDataDict = new Dictionary<string,List<ExampleUserDefineData.DAL.UserDefData>> ();
            ...
            wizard.ValidateStart += delegate(object sender, SmartSchool.API.PlugIn.Import.ValidateStartEventArgs e)
            {
                ...
                loader1.PackageWorker += delegate(object sender1, PackageWorkEventArgs<string> e1)
                {
                    ...
                    {   
                        ...
                        {
                            List<DAL.UserDefData> dd = new List<ExampleUserDefineData.DAL.UserDefData>();
                            dd.Add(udd);
            ...
            { 
                ...
                List<DAL.UserDefData> InsertList = new List<ExampleUserDefineData.DAL.UserDefData> ();
                List<DAL.UserDefData> DeleteList = new List<ExampleUserDefineData.DAL.UserDefData>();
                ...
                foreach (string id in id_Rows.Keys)
                {
                    foreach (RowData data in id_Rows[id])
                    {
                        ...
                        // 新增資料
                        DAL.UserDefData uddNew = new ExampleUserDefineData.DAL.UserDefData();
