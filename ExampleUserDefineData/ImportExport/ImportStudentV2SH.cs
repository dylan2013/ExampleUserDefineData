...
{
    public partial class ImportStudentV2SH : FISCA.Presentation.Controls.BaseForm, SmartSchool.API.PlugIn.Import.ImportWizard
    {
        ...
        public ImportStudentV2SH(string title, Image img)
        {
            InitializeComponent();
