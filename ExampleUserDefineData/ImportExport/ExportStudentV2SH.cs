...
{
    public partial class ExportStudentV2SH : FISCA.Presentation.Controls.BaseForm, SmartSchool.API.PlugIn.Export.ExportWizard
    {
        ...
        public ExportStudentV2SH(string title, Image img)
        {
            InitializeComponent();
                            ...
                            if (RowIndex <= 65535)
                            {
                                ...
                                for (; i < studentFieldList.Count; i++)
                                {
                                    switch (studentFieldList[i])
                                    {
                                        ...
                                        case "科別": report.Worksheets[0].Cells[RowIndex, i].PutValue(student); break;
