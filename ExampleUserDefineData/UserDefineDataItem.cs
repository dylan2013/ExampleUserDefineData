...
namespace ExampleUserDefineData
{
    ...
    public partial class UserDefineDataItem : DetailContent
    {
        ...
        {
            InitializeComponent();
            _DeleteDataList = new List<ExampleUserDefineData.DAL.UserDefData>();
            _InsertDataList = new List<ExampleUserDefineData.DAL.UserDefData>();
            ...
            try
            {
                ...
                if (canSave)
                {
                    ...
                    foreach (DataGridViewRow row in dgv.Rows)
                    {
                        if (row.IsNewRow)
                            continue;
                        DAL.UserDefData udd = new ExampleUserDefineData.DAL.UserDefData();
                        // 資料轉型                      
